...
public class Main4Activity extends AppCompatActivity {
    ...
    Integer[] cards_Array = {101, 102, 103, 104, 201, 202, 203, 204};
 ...
 */
    ...
    private void checkEnd () {
        if (iv_11.getVisibility() == View.INVISIBLE && iv_12.getVisibility() == View.INVISIBLE
         ...
         && iv_33.getVisibility() == View.INVISIBLE && iv_34.getVisibility() == View.INVISIBLE*/) {
            AlertDialog.Builder alterdialogbuilder = new AlertDialog.Builder(Main4Activity.this);
    ...
    private void frontofcardsResources () {
        ...
        //image105 = R.drawable.ponecopy;
        //image106 = R.drawable.ptwocopy;
