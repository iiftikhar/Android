...
public class Main5Activity extends AppCompatActivity {
    ...
    Integer[] cards_Array = {101, 102, 103, 104, 105, 106, 201, 202, 203, 204, 205, 206};
...
//        tv_p2.setTextColor(Color.GRAY);
    ...
    private void doStuff (ImageView iv, Integer card){
        ...
        } else if (cards_Array[card] == 103) {
            iv.setImageResource(image103);

        } else if (cards_Array[card] == 104) {
            iv.setImageResource(image104);

        } else if (cards_Array[card] == 105) {
            iv.setImageResource(image105);

        } else if (cards_Array[card] == 106) {
        ...
        } else if (cards_Array[card] == 203) {
            iv.setImageResource(image203);

        } else if (cards_Array[card] == 204) {
            iv.setImageResource(image204);

        } else if (cards_Array[card] == 205) {
            iv.setImageResource(image205);

        } else if (cards_Array[card] == 206) {
    ...
    private void calculate () {
        ...
        if (firstcard == secondcard) {
            ...
            if (turn == 1) {
                ...
                playerpoint++;
//                tv_p2.setText("P2 :" + playerpoint);
            }
        } else {
            iv_11.setImageResource(R.drawable.solve);
            iv_12.setImageResource(R.drawable.solve);
            iv_13.setImageResource(R.drawable.solve);
            iv_14.setImageResource(R.drawable.solve);


            iv_21.setImageResource(R.drawable.solve);
            iv_22.setImageResource(R.drawable.solve);
            iv_23.setImageResource(R.drawable.solve);
            iv_24.setImageResource(R.drawable.solve);


            iv_31.setImageResource(R.drawable.solve);
            iv_32.setImageResource(R.drawable.solve);
            iv_33.setImageResource(R.drawable.solve);
            iv_34.setImageResource(R.drawable.solve);
...
//                tv_p2.setTextColor(Color.BLACK);
    ...
    private void checkEnd () {
        if (iv_11.getVisibility() == View.INVISIBLE && iv_12.getVisibility() == View.INVISIBLE
            ...
            AlertDialog.Builder alterdialogbuilder = new AlertDialog.Builder(Main5Activity.this);
    ...
    private void frontofcardsResources () {
        ...
        image103 = R.drawable.pseven;
        image104 = R.drawable.pnine;
        image105 = R.drawable.pthreecopy;
        image106 = R.drawable.psix;

        image201 = R.drawable.ponecopy;
        image202 = R.drawable.ptwocopy;
        image203 = R.drawable.psevencopy;
        image204 = R.drawable.pnine;
        image205 = R.drawable.pthree;
